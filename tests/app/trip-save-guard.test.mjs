...
test('trip save guard blocks new save without resolved active trip and merges membership after successful save', async () => {
  ...
  assert.match(source, /setDoc\(itemRef,\s*membership,\s*\{\s*merge:\s*true\s*\}\)/s);
