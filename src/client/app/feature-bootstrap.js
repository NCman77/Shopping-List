...
if (typeof window !== 'undefined' && typeof document !== 'undefined') {
  void runEnhancementsIndependently(
    ...
    async () => {
      ...
      const { initItemFormPricingLocations } = await import('./item-form-pricing-locations.js');
      await initItemFormPricingLocations();
    ...
    const labels = ['旅程資料', '國家篩選', '帳號設定', 'Maps 模式', '旅程介面', '旅程篩選選項', '完整篩選選單', '背景個人化', '設定合併保護', '商品旅程儲存／複選地點／價格／商店位置', '附近排序', '商品狀態與分頁', '商品照片介面修復', '商品跨旅程複製', 'PWA 安裝'];
